...
BASE_URL = "https://www.jobstreet.co.id/id/python-jobs/in-Surabaya-Jawa-Timur?specialization=508%2C186?createdAt=3d"
INCLUDE_KEYWORDS = ["python", "selenium", "microcontroller",
                    "arduino", "stm32", "esp32", "sensor", "iot", "excel", "sql", "analyst", "trainee", "wfh", "remote", "intern"]
...
# BASE_URL = "https://www.jobstreet.co.id/id/oil-jobs?specialization=190%2C195%2C200%2C510"
# KEYWORDS = ["teknik mesin"]
